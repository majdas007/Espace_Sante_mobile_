...
public class Annonce {
    ...
    public String toString() {
        return "Annonce{" + "titre_annonce=" + titre_annonce + ", date_annonce=" + date_annonce + ", desc_annonce=" + desc_annonce + ", addr_annonce=" + addr_annonce + ", tel_annonce=" + tel_annonce + ", img_annonce=" + img_annonce + '}';
    }

    public Annonce(String id_annonce, String type_annonce, String titre_annonce, String date_annonce, String desc_annonce, String addr_annonce, int tel_annonce, String img_annonce) {
    ...
    public Annonce(String titre_annonce) {
     ...
     public Annonce( String titre_annonce,String desc_annonce, String addr_annonce, int tel_annonce) {
         this.titre_annonce = titre_annonce;
        this.desc_annonce = desc_annonce;
        this.addr_annonce = addr_annonce;
        this.tel_annonce = tel_annonce;
    ...
    public Annonce(String id_annonce,String type_annonce, String titre_annonce, String date_annonce, String desc_annonce, String addr_annonce, int tel_annonce, String img_annonce, int id_user) {
