 ...
 * @author tarek
 */
public class AfficherOffreDetail extends BaseForm {
    ...
    public AfficherOffreDetail(String id, Resources res) {
...
//       lb.setText(list.get(0).getTitre_annonce());
    public Container addContact(Annonce c, String nom, String desc, Resources res) {
        ...
        annuler.addActionListener((l) -> {
            {
                AfficherOffreDetail h = new AfficherOffreDetail(c.getId_annonce(), res);
                h.getF().show();
        ...
        confirm.addActionListener((evt) -> {
            ...
            ann.editOffre(c.getId_annonce(), a.getText(), b.getText(), cc.getText(), d.getText());
            new AfficherOffreDetail(c.getId_annonce(), res).getF().show();
        ...
        bn.addActionListener((evt) -> {
            ...
            abb.deleterep(c.getId_annonce());
            AfficherOffre b1 = new AfficherOffre(res);
            b1.getF().show();
